...
|------------|----------|--------------|-------------|-------------|
| [Global Data Network](https://gdn1.macrometa.io/) | demo@macrometa.io | `xxxxxxxx`| graphdemo | [github](https://github.com/Macrometacorp/docs-demos/blob/master/fraud-detection-queries.md)|
