...
You should use [bind parameters](../fundamentals/bind-parameters.md) instead whenever possible, use query building functionality if provided by a driver or at least sanitize user input with great care.
