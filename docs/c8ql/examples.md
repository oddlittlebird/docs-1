...
We use the city graph and its geo indices: ![cities_graph\(1\)](images/cities_graph.png){height="" width=""}
...
For example, if this is the full graph (based on the [mps_graph](images/mps_graph.png)):
