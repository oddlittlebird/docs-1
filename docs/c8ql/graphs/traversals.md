...
![traversal_graph](../../images/traversal_graph.png)
...
![traversal_graph1](../../images/traversal_graph1.png)

Now it walks to one of the direct neighbors of **A**, say **B** (note: ordering is not guaranteed!):

![traversal_graph2](../../images/traversal_graph2.png)
...
![traversal_graph3](../../images/traversal_graph3.png)
...
![traversal_graph4](../../images/traversal_graph4.png)
...
![traversal_graph5](../../images/traversal_graph5.png)

And identical to the iterations before we will visit **H**:

![traversal_graph6](../../images/traversal_graph6.png)

And **J**:

![traversal_graph7](../../images/traversal_graph7.png)
