...
However, as shown in this example based on the [knows_graph](../../../images/knows_graph.png), a query for this use case can be created.
...
For example, the [city graph](../../../images/cities_graph.png) contains several vertex collections - `germanCity` and `frenchCity` and several edge collections -  `french / german / international Highway`.
